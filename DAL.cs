...
namespace CrudMahasiswaADO
{
    public class DAL
    {
        ...
        private static string connectionString = $"Data Source={Environment.MachineName}\\PUTRASQL; Initial Catalog=DBAkademikADO; Integrated Security=True; TrustServerCertificate=True";
